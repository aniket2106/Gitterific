...
public class HomeController extends Controller {
    ...
    @Inject
    public HomeController(ActorSystem system, WSClient ws, GithubApi serviceImpl) {
        this.ws = ws;
    ...
    public Result index(Http.Request request, String searchKeyword) {
        ...
        //                 ok(views.html.index.render(Session.getSearchResultsHashMapFromSession(request)))
        //                         .addingToSession(request, Session.getSessionKey(), Integer.toString(counter)));
        //     } else {
        //         return CompletableFuture.completedFuture(
        //                 ok(views.html.index.render(Session.getSearchResultsHashMapFromSession(request))));
        //     }
    ...
    // public WebSocket ws(){
    // return WebSocket.Json.accept(request -> ActorFlow.actorRef(s ->
    // GithubActor.props(s,wsClient), actorSystem, materializer));
    // }
